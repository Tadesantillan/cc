...
# Definir la URL para acceder a los archivos de medios (esto es lo que los navegadores usarán)
MEDIA_URL = '/media/'

# Definir la ruta donde se guardarán los archivos de medios en tu sistema (en el directorio BASE_DIR)
